...
$un = $_SESSION['un']; // Retrieve username from session
if(!$un) {
...
<div id="full">
<div id="inner_full">
<div id="header"> <h2><a href="user-home.php" style="text-decoration: none;color: white;">Blood Bank Management System</a></h2></div>
 <div id="body">
<br>
